...
namespace Hackcom.Dapper
{
    ...
    public interface IDapperRepository<T>
    {
        ...
        IEnumerable<U> ExecuteStroedProc<U>(string storedProcName, object param);
    ...
    public class DapperRepository<T> : IDapperRepository<T>
    {
        ...
        public IEnumerable<U> ExecuteStroedProc<U>(string storedProcName, object param)
        {
            return UsingDb(db => db.Query<U>(storedProcName, param, commandType:CommandType.StoredProcedure));
        }
