...
namespace Hackcom.Dapper
{
    ...
    public interface IDapperRepository<T>
    {
        ...
        int Remove(string where, object param = null);
        int Execute(string sql, object param);
        IEnumerable<U> ExecuteStroedProc<U>(string storedProcName, object param = null, int? commandTimeout = null);
    ...
    {
        private const string DELETE_QUERY = "Delete {0} Where {1}";
        #region Properties
        ...
        {
            string sql = string.Format(DELETE_QUERY, TableName, QueryPrimaryKey);
            return UsingDb(db => db.Execute(sql, primaryKey));
        }

        public virtual int Remove(string where, object param = null)
        {
            string sql = string.Format(DELETE_QUERY, TableName, where);
            return UsingDb(db => db.Execute(sql, param));
        }
        ...
        public IEnumerable<U> ExecuteStroedProc<U>(string storedProcName, object param = null, int? commandTimeout = null)
        {
            return UsingDb(db => db.Query<U>(storedProcName, param, commandType:CommandType.StoredProcedure, commandTimeout: commandTimeout));
        }
